package com.sgdea.multitenancy.multitenancy.domain.companyProvisioning.exceptions;
...
@RestControllerAdvice(basePackages = "com.sgdea.multitenancy.multitenancy.entrypoints.companyProvisioning")
public class CompanyProvisioningExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleValidation(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDto.error("La solicitud de provisionamiento de empresa tiene campos invalidos", errors));
    }
}
