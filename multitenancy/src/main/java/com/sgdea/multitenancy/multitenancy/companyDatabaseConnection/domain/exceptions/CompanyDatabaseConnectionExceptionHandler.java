package com.sgdea.multitenancy.multitenancy.companyDatabaseConnection.domain.exceptions;
...
@RestControllerAdvice(basePackages = "com.sgdea.multitenancy.multitenancy.entrypoints.companyDatabaseConnection")
public class CompanyDatabaseConnectionExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleValidation(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDto.error("La solicitud de conexion de base de datos tiene campos invalidos", errors));
    }
}
