package com.sgdea.multitenancy.multitenancy.domain.company.exceptions;
...
@RestControllerAdvice(basePackages = "com.sgdea.multitenancy.multitenancy.entrypoints.company")
public class CompanyExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleValidation(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDto.error("La solicitud de empresa tiene campos invalidos", errors));
    }
}
