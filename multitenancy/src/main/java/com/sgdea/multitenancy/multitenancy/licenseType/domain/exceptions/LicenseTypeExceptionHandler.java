package com.sgdea.multitenancy.multitenancy.licenseType.domain.exceptions;
...
public class LicenseTypeExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleValidation(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDto.error("La solicitud de tipo de licencia tiene campos invalidos", errors));
    }
}
