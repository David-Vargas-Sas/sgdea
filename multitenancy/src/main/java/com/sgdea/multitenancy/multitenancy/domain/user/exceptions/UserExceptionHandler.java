package com.sgdea.multitenancy.multitenancy.domain.user.exceptions;
...
@RestControllerAdvice(basePackages = "com.sgdea.multitenancy.multitenancy.entrypoints.user")
public class UserExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleValidation(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity.badRequest().body(ApiResponseDto.error("La solicitud de usuario tiene campos invalidos", errors));
    }
}
