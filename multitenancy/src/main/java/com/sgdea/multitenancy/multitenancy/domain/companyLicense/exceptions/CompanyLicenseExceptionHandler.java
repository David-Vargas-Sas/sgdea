package com.sgdea.multitenancy.multitenancy.domain.companyLicense.exceptions;
...
@RestControllerAdvice(basePackages = "com.sgdea.multitenancy.multitenancy.entrypoints.companyLicense")
public class CompanyLicenseExceptionHandler {
    ...
    public ResponseEntity<ApiResponseDto<Void>> handleValidation(MethodArgumentNotValidException exception) {
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponseDto.error("La solicitud de licencia de empresa tiene campos invalidos", errors));
    }
}
